# src/morph_pde/utils/transformer_encoder_axialattention_3dspacetime.py
import torch.nn as nn
from morph_pde.utils.axial_attention_3dspacetime_2_lora import AxialAttention3DSpaceTime
